  ...
  // ========================= CHAPTER 2 =========================
  {
    ...
    areas: [
      ...
      },
      {
        ...
        // Real painted level; geometry in data/level-hungover.js.
        plate: HUNGOVER_PLATE,
      },
      {
        name: "The Lecture Theatre", feel: "tiered seats funnel to the stage", boss: true,
        // Real painted level; geometry in data/level-lecture.js.
        plate: LECTURE_PLATE,
      },
    ],
  },
    ...
    areas: [
      {
        ...
        // Real painted level; geometry in data/level-playhouse.js.
        plate: PLAYHOUSE_PLATE,
      },
      {
        name: "The NUA Library", feel: "shelf corridors", enemyBudget: 8,
        // Real painted level; geometry in data/level-library.js.
        plate: LIBRARY_PLATE,
      },
      {
        name: "Norwich Streets", feel: "the mad dash - long and narrow", enemyBudget: 9, sidescroll: true,
        // Real painted level; geometry in data/level-streets.js.
        plate: STREETS_PLATE,
      },
      {
        name: "Outside the Cathedral", feel: "calm before the ceremony", enemyBudget: 0, quiet: true,
        // Real painted level; geometry in data/level-cathedralclose.js.
        plate: CATHEDRALCLOSE_PLATE,
      },
      {
        name: "The Cathedral", feel: "pews make lanes, aisles for flanking", boss: true,
        // Real painted level; geometry in data/level-cathedral.js.
        plate: CATHEDRAL_PLATE,
      },
    ],
  },
